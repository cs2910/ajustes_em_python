...
cursor_postgres.execute(f"select * from central.pessoa")
...
cursor_postgres.execute(f"SELECT column_name, data_type FROM information_schema.columns WHERE table_name = '{tabela}' AND table_schema = 'central'")
