...
#### Linka
urlPost = 'https://tributos.betha.cloud/service-layer-tributos/api/economicos/'
#### Token da Endidade
...
query = text("select * from ecocep where novocep  is not null and protocolo is null")
...
##        print("entrou")
        ...
        stmt = text(f"UPDATE ecocep SET protocolo = '{f_token_retorno}' WHERE id = '{tabela.id}'")
        ##print(stmt)
