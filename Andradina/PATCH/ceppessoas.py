...
query = text("select * from pensend where novocep is not null and protocolo is null")
...
##        print("entrou")
        ...
        stmt = text(f"UPDATE pensend SET protocolo = '{f_token_retorno}' WHERE id = '{tabela.id}'")
##        print(stmt)
