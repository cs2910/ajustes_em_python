...
query = text("select st_condic_acamado,st_condic_domiciliado,st_condic_ulceras_feridas,st_condic_acompanham_nutricion,"
             ...
             "st_condic_suport_ventil_bipap,st_condic_dialise_peritonial,st_condic_paracentese,st_condic_medicacao_parenteral, ad.codigo, ad.id_gerado "
             "from cnv_elegibilidade ad "
             "where ad.id_gerado is not null and protocolocaval is null and sequenc > 133501")
...
for tabela in resultados:
    ...
    ##        print("entrou")
            ...
            stmt = text(f"UPDATE cnv_elegibilidade SET protocolocaval = '{f_token_retorno}' WHERE  id_gerado = '{tabela.id_gerado}'")
