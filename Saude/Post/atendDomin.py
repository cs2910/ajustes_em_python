...
query = text("select ad.sequenc, ad.id_cidadao,ad.id_unidade,ad.id_profissional,classificacaocarater,"
             ...
             " where a.protocolo is not null and modalidade  in ('AD3','AD1','AD2') "
             " and id_gerado is not null  and ad.sequenc = 533097 "
             "order by ad.sequenc ")
            ...
            "atendimentoDomiciliarAvaliarElegibilidade": {
                ...
                **cidsecund02,
                ...
                "classificacaoFrequencia": {
                    "id": tabela.classificacaocarater
                },
                "classificacaoModalidade": {
                    "id": modalid
                },
                "classificacaoTipoCuidador": {
                    "id": 5038
                },
                "unidadePrestadora": {
                    "id": tabela.id_unidade
